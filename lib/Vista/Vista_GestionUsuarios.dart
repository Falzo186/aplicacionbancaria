...
class _VistaReporteUsuariosState extends State<VistaReporteUsuarios> {
  ...
  List<ReporteSolicitud> reportes = []; // Lista de reportes del usuario seleccionado
  ...
  void _cargarUsuarios() {
    ...
    Controlador.obtenerUsuariosEscritorio ().then((usuarios) {
      setState(() {
  ...
  Future<void> _cargarReportes(String nombreUsuario) async {
    ...
    try {
      ...
      final reportesObtenidos = await ControladorReporte.obtenerReportesPorUsuario(nombreUsuario);
      setState(() {
              ...
              child: Container(
                ...
                child: ListView.builder(
                  ...
                  itemBuilder: (context, index) {
                    ...
                    setState(() {
                      usuarioSeleccionado = usuario; // Guarda el usuario seleccionado
                      reportes.clear(); // Limpia la lista de reportes mientras carga
                    });
                                ...
                                return Card(
                                  ...
                                  child: ListTile(
                                    ...
                                    subtitle: Column(
                                      crossAxisAlignment: CrossAxisAlignment.start,
                                      children: [
                                        Text("ID Solicitud: ${reporte.idSolicitud}"),
                                        ...
                                        builder: (context) {
                                          return AlertDialog(
                                            ...
                                            content: Column(
                                              ...
                                              children: [
                                                Text("ID Solicitud: ${reporte.idSolicitud}"),
                                                Text("Tipo de Solicitud: ${reporte.tipoSolicitud}"),
                                                Text("Cliente: ${reporte.clienteNombre}"),
                                                Text("Estado: ${reporte.estado}"),
                                                Text("Fecha de Solicitud: ${_formatearFecha(reporte.fechaSolicitud)}"),
                                              ],
                                            ),
                                            actions: [
                                              TextButton(
