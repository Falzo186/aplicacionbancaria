...
class _VistaDatosClienteState extends State<VistaDatosCliente> {
  ...
  Future<void> _initializeData() async {
    try {
      prestamos = await controlador.buscarPrestamosPorCuenta(widget.cliente.numeroCuenta);
      seguros = await controlador.buscarSegurosPorCuenta(widget.cliente.numeroCuenta);
      inversiones = await controlador.buscarInversionesPorCuenta(widget.cliente.numeroCuenta);
      transferencias = await controlador.obtenerTransferencias();

      fechaApertura = (await controlador.obtenerFechaApertura(widget.cliente.numeroCuenta))!;
      ...
      sumaTransferencias = transferencias.fold(0, (sum, item) => sum + item.monto);
                  ...
                  Row(
                    children: [
                      ...
                      DropdownButton<String>(
                        ...
                        items: ['Información General', 'Préstamos', 'Seguros', 'Transferencias']
                      ...
                      child: Padding(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            Text('Número de Transferencias: $totalTransferencias'),
                            Text('Cliente desde: ${fechaApertura.day}/${fechaApertura.month}/${fechaApertura.year}'),
                            SizedBox(height: 16),
                            // Gráficas
                            SizedBox(
                              height: 200,
